...
route.get('/tables', services.ensureAuthenticated,dashboardViewtables, services.tables);
...
route.get('/table_1_order', services.ensureAuthenticated,services.table_1_order);
route.post('/table_1_order',services.ensureAuthenticated,services.insertOrder);
route.get('/table_2_order', services.ensureAuthenticated,services.table_2_order);
route.post('/table_2_order',services.ensureAuthenticated,services.insertOrder2);
